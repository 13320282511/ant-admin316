var funSheet18 = function(SheetArea,spread){
  /*
   *  发展党员情况（一）
   */
  var sheet = spread.getSheet(17);
  ...
  sheet.setValue(23, 0,"补充资料：截至2016年底，共有劳务", SheetArea.rowHeader);
  sheet.setValue(23, 0,"派遣工发展对象");
  sheet.setValue(23, 2, "名，其中女性");
  sheet.setValue(23, 4, "名，35岁及以下的");
  sheet.addSpan(23, 6, 1, 2);
  sheet.setValue(23, 6, "名，大专及以上学历的");
  sheet.setValue(23, 9, "名");
  ...
  sheet.setStyle(23,3,newStyle("#FFCC99"));
