var funSheet23 = function(SheetArea,spread){
  /*
   *  发展党员情况（一）
   */
  var sheet = spread.getSheet(22);
  sheet.isPaintSuspended(true);
  sheet.name('城市街道、社区（居委会）、社会组织发展党员工作情况（二）');
  ...
  sheet.setValue(0, 0,"入党积极分子", SheetArea.rowHeader);
  ...
  sheet.setValue(9, 0,"入党申请人", SheetArea.rowHeader);
